...
/**
 * The type Ownership access level.
 */
@Component
public class OwnershipAccessLevel implements AccessLevel {

    @Override
    public boolean accept(EntityAccessDefinition accessDefinition, String entityId, User accessingUser) {
        return accessDefinition.whoOwns(entityId).equals(accessingUser.getId());
    }
}
